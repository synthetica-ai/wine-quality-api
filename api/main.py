...
from db import db
from resources.wines import getMaxFixedAcidicity, getBottomDensityWines, getNeutralWines, getTopAlchoholWines, removeWine, editWine, addWine    
...
api.add_resource(getTopAlchoholWines, '/api/getTopAlcoholWines')
